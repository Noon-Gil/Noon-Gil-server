        ...
        await axios(requestConfig)
          .then(async (response) => {
            ...
            const chatCompletion = await openai.createChatCompletion({
              model: "gpt-3.5-turbo",
              messages: [
                {role: "system", content: "너는 질문의 의도를 넷 중 하나로 분류하는 분류기야. USER는 보이는 장면을 궁금해하거나, 앞에 있는 사람이 어떤 사람을 닮았는지 궁금해하거나, 무엇이 적혀있는지 궁금해하고 있어. 장면을 궁금해할 경우 \"object-detection\", 앞 사람이 누구를 닮았는지 궁금해할 경우 \"face-recognition\" 글자를 궁금해할 경우 \"tts\", 그리고 상대의 기분,표정을 궁금해할 경우 \"emotion\", 반드시 이 넷 중 하나의 단어로만 답변해야해."},
